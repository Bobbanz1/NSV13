...
// NSV13 - CHANGES START - ALTERATION TO PREFERENCE REDUX, UNCOMMENT ONCE BEEMERGE HAPPENS
...
#define PREFERENCE_TAG_PREFERRED_SYNDIE_ROLE "preferred_syndie_role" //NSV13 - syndicate crew role
// NSV13 - CHANGES STOP
