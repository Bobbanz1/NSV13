...
#define VERB_CONSENT							(1<<14) // Skyrat - ERP Mechanic Addition
#define LEWD_VERB_SOUNDS						(1<<15) // Skyrat - ERP Mechanic Addition
...
//NSV13 - ERP prefs
#define PREFERENCE_TAG_ERPPREF			"28"
#define PREFERENCE_TAG_NONCONPREF		"29"
#define PREFERENCE_TAG_AROUSABLE		"30"
#define PREFERENCE_TAG_CIT_TOGGLES		"31"
