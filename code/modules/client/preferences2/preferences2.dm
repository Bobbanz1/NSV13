...
/datum/preferences/proc/load_from_database()
	...
	READPREF_RAW(erppref, PREFERENCE_TAG_ERPPREF) //NSV13
	READPREF_RAW(nonconpref, PREFERENCE_TAG_NONCONPREF) //NSV13
	READPREF_RAW(arousable, PREFERENCE_TAG_AROUSABLE) //NSV13
	READPREF_RAW(cit_toggles, PREFERENCE_TAG_CIT_TOGGLES) //NSV13
	...
	erppref = sanitize_inlist(erppref, GLOB.lewd_prefs_choices, "Ask")
	nonconpref = sanitize_inlist(nonconpref, GLOB.lewd_prefs_choices, "Ask")
...
/datum/preferences/proc/save_preferences()
	...
	PREP_WRITEPREF_RAW(erppref, PREFERENCE_TAG_ERPPREF) //NSV13
	PREP_WRITEPREF_RAW(nonconpref, PREFERENCE_TAG_NONCONPREF) //NSV13
	PREP_WRITEPREF_RAW(arousable, PREFERENCE_TAG_AROUSABLE) //NSV13
	PREP_WRITEPREF_RAW(cit_toggles, PREFERENCE_TAG_CIT_TOGGLES) //NSV13
