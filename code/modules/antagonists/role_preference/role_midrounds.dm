...
/datum/role_preference/midround_ghost/fugitive_hunter/get_preview_icon()
	var/icon/final_icon = icon('icons/effects/effects.dmi', "nothing")
	var/icon/foreground = render_preview_outfit(/datum/outfit/bountyarmor) ///NSV13 - bounty/hook = bountyarmor - We don't have that other thing currently.
	var/icon/background = render_preview_outfit(/datum/outfit/russiancorpse/hunter) ///NSV13 - russian_hunter/leader = russiancorpse/hunter - We don't have that other thing currently.
	var/icon/background_2 = render_preview_outfit(/datum/outfit/spacepol) ///NSV13 - spacepol/sergeant = spacepol - We don't have that other thing currently.
	background.Blend(rgb(206, 206, 206, 220), ICON_MULTIPLY)
