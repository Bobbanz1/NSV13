/datum/job/paramedic
	...
	access = list(ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_SURGERY, ACCESS_CLONING, ACCESS_MECH_MEDICAL, ACCESS_MINERAL_STOREROOM,
					...
					//NSV13 start
					ACCESS_GENETICS, ACCESS_CHEMISTRY,
					ACCESS_ENGINE, ACCESS_ATMOSPHERICS, ACCESS_RESEARCH, ACCESS_ROBOTICS,
					ACCESS_CARGO, ACCESS_MINING, ACCESS_MINING_STATION, ACCESS_KITCHEN, ACCESS_CREMATORIUM,
					ACCESS_MUNITIONS)
					//NSV13 end
