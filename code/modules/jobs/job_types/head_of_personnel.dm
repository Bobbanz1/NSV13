/datum/job/head_of_personnel
	...
	flag = HOP
	description = "Second in command on the ship, oversee the crew assigned to service and cargo positions, handle department transfer requests by consulting relevant heads. Protect Ian at all costs." //NSV13 - station -> ship
