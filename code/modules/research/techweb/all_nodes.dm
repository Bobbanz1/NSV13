...
/datum/techweb_node/base
	...
	"rglass","plasteel","plastitanium","plasmaglass","plasmareinforcedglass","titaniumglass","plastitaniumglass","plumbing_rcd", "antivirus", "glasses_prescription", "light_replacer", "xenoa_labeler", "nanocarbon_glass", "durasteel", "duranium")
...
/datum/techweb_node/cyborg_upg_med
	...
	prereq_ids = list("adv_biotech")
	design_ids = list("borg_upgrade_defibrillator", "borg_upgrade_piercinghypospray", "borg_upgrade_expandedsynthesiser", "borg_upgrade_pinpointer", "borg_upgrade_surgicalprocessor", "borg_upgrade_beakerapp", "borg_upgrade_surgicaltools") //NSV13 - Added Borg Upgrade Surgical Tools
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2000)
	export_price = 5000
